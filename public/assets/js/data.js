...
export const BOOKS = Object.freeze([
  Object.freeze({
    id: "siddhartha",
    coverAspect: 987 / 1500,
    title: Object.freeze({ en: "Siddhartha", es: "Siddhartha" }),
    author: "Hermann Hesse",
    url: "https://www.goodreads.com/book/show/21480838-siddhartha",
    shelf: "read",
    shelfOrder: 3,
    pageCount: 211,
    accentColor: "#3c3489",
    spineColor: "#e0dfd9",
    backColor: "#e0dfd9",
    coverUrl: "https://m.media-amazon.com/images/I/91Bi7C1ML0L._SL1500_.jpg",
  ...
  Object.freeze({
    id: "the-stranger",
    coverAspect: 1684 / 2560,
    title: Object.freeze({ en: "The Stranger", es: "El Extranjero" }),
    author: "Albert Camus",
    url: "https://www.goodreads.com/book/show/59062200-el-extranjero",
    shelf: "read",
    shelfOrder: 3,
    pageCount: 120,
    accentColor: "#c7c6c7",
  ...
  Object.freeze({
    id: "white-nights",
    coverAspect: 990 / 1536,
    title: Object.freeze({ en: "White Nights", es: "Noches Blancas" }),
    author: "Fyodor Dostoevsky",
    url: "https://www.goodreads.com/book/show/228811127-noches-blancas",
    shelf: "read",
    shelfOrder: 3,
    pageCount: 112,
    accentColor: "#d4c0a4",
    spineColor: "#ffffff",
    backColor: "#ffffff",
    coverUrl: "https://www.galaxiagutenberg.com/wp-content/uploads/2025/05/Cub_Noches-blancas-115x180-1-990x1536.jpg",
    // Identical artwork, served locally because the publisher does not allow CORS textures.
    coverTextureUrl: "/assets/images/covers/white-nights.jpg",
    description: Object.freeze({
  ...
  Object.freeze({
    ...
    coverAspect: 986 / 1500,
    title: Object.freeze({ en: "The Metamorphosis", es: "La Metamorfosis" }),
    author: "Franz Kafka",
    url: "https://www.goodreads.com/book/show/1626807.La_transformaci_n",
    shelf: "current",
    shelfOrder: 1,
    pageCount: 128,
    accentColor: "#aa7764",
    spineColor: "#009760",
    backColor: "#009760",
    coverUrl: "https://m.media-amazon.com/images/I/610bz0hmLcL._SL1500_.jpg",
    description: Object.freeze({
  ...
  Object.freeze({
    ...
    coverAspect: 928 / 1500,
    title: Object.freeze({ en: "The Bhagavad Gita", es: "El Bhagavad Gita" }),
    author: "Krishna-Dwaipayana Vyasa",
    spineAuthor: "",
    url: "https://www.goodreads.com/book/show/358540.The_Bhagavad_Gita",
    shelf: "want",
    shelfOrder: 2,
    pageCount: 294,
    accentColor: "#6c584f",
    spineColor: "#976a2d",
    backColor: "#976a2d",
    coverUrl: "https://m.media-amazon.com/images/I/71nDBHiOzIL._SL1500_.jpg",
    description: Object.freeze({
